...
<form action="<?php echo base_url('myadmin/admin_menu/edit_menu/'.$this->uri->segment(4))?>" method="post" class="form-bordered" >
<div class="form-group">
<label class="col-sm-3 control-label">Parent Id</label>
<div class="col-sm-6">
<input type="text" class="form-control" name="parent_id" id="parent_id" value="<?php echo $row->parent_id?>"   >
</div>
</div>
<div class="form-group">
...
<div class="col-sm-6">
<input type="text" class="form-control" name="controller_name" id="controller_name" value="<?php echo $row->controller_name?>"   >
</div>
</div>
<div class="form-group">
<label class="col-sm-3 control-label">Page Name</label>
<div class="col-sm-6">
<input type="text" class="form-control" name="page_name" id="page_name" value="<?php echo $row->page_name?>"   >
</div>
</div>
