...
class Ajax_pagination{
	...
	var $last_link			= 'Last';
	var $uri_segment		= 2;
	var $full_tag_open		= '<ul class="pagination primary mt-4">';
	...
	var $num_tag_close		= '';
	var $target             = '';
    var $anchor_class		= 'class="page-link"';
    var $show_count         = true;
	...
	function create_links(){
		...
		if ($num_pages == 1){
            $info = '<p class="color-yellow mt-3 mb-5 funkyfont-kalam-bold">Showing:</p>' . $this->total_rows;
			return $info;
		}
		...
		if ($this->show_count){
			...
			$info =  '<p class="color-yellow mt-1 mr-3 funkyfont-kalam-bold">Showing:'.( $curr_offset + 1 ) . ' to ' ;
        ...
        function getData(page){ 
            ...
            $.ajax({
                ...
                data: { page: page,state_name:state,city_name:city },
                beforeSend: function(){
